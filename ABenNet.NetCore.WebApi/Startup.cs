...
namespace ABenNet.NetCore.WebApi
{
    public class Startup
    {
        ...
        private const string _defaultCorsPolicyName = "ABenNet.NetCore.WebApi.Cors";
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Config cors policy
            services.AddCors(options => options.AddPolicy(_defaultCorsPolicyName, builder =>
                                        builder.WithOrigins(Configuration["Application:CorsOrigins"].Split(",",
